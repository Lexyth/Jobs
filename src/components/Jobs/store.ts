...
export const jobsStore = createPersistentCSVStore<Job>(
    ...
    (arr: string[]): Job => {
        ...
        if (arr[1] === undefined)
            throw new Error("Parsed clientId at index 1 from " + arr + " was undefined.");
        const clientId = parseInt(arr[1]);
        if (Number.isNaN(clientId))
            throw new Error("Parsed clientId at index 1 from " + arr + " was not a number.");
        if (arr[2] === undefined)
            throw new Error("Parsed date at index 2 from " + arr + " was undefined.");
        if (arr[3] === undefined)
            throw new Error("Parsed description at index 3 from " + arr + " was undefined.");
        if (arr[4] === undefined)
            throw new Error("Parsed price at index 4 from " + arr + " was undefined.");
        const price = parseFloat(arr[4]);
        if (Number.isNaN(price))
            throw new Error("Parsed price at index 4 from " + arr + " was not a number.");
        if (arr[5] === undefined)
            throw new Error("Parsed count at index 5 from " + arr + " was undefined.");
        const count = parseFloat(arr[5]);
        if (Number.isNaN(count))
            throw new Error("Parsed count at index 5 from " + arr + " was not a number.");
        if (arr[6] === undefined)
            throw new Error("Parsed total at index 6 from " + arr + " was undefined.");
        const total = parseFloat(arr[6]);
        if (Number.isNaN(total))
            throw new Error("Parsed total at index 6 from " + arr + " was not a number.");
        if (arr[7] === undefined)
            throw new Error("Parsed vat at index 7 from " + arr + " was undefined.");
        const vat = parseFloat(arr[7]);
        if (Number.isNaN(vat))
            throw new Error("Parsed vat at index 7 from " + arr + " was not a number.");
        if (arr[8] === undefined)
            throw new Error("Parsed status at index 8 from " + arr + " was undefined.");
